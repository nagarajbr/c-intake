...
filename = "lib/tasks/batch/Daily/OCSE/to_OCSE/outbound/OCSE_" + ls_file_date.to_s + ".txt"
log_filename = "lib/tasks/batch/Daily/OCSE/to_OCSE/results/OCSE_log_" + "#{Date.today.strftime("%m%d%Y")}"+"#{Time.now.strftime("%H%M%S")}" + ".txt"
