namespace :access_rights_for_case_manager do
	...
	task :create_access_rights_case_manager => :environment do
		...
		AccessRight.create(role_id: user_role_id, ruby_element_id: 64,   access:'Y', created_at: Time.now, updated_at: Time.now)   # "Program Management"
			...
			AccessRight.create(role_id: user_role_id, ruby_element_id: 71,   access:'Y', created_at: Time.now, updated_at: Time.now)   # "Check Eligibility"
				...
				AccessRight.create(role_id: user_role_id, ruby_element_id: 73,   access:'N', created_at: Time.now, updated_at: Time.now)   # "Submit"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 74,   access:'N', created_at: Time.now, updated_at: Time.now)   # "Summary"
		...
		AccessRight.create(role_id: user_role_id, ruby_element_id: 135,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Workload Management"
			...
			AccessRight.create(role_id: user_role_id, ruby_element_id: 138,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Workload Queues"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 139,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Intake Queues"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 140,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Workload Queues"
			...
			AccessRight.create(role_id: user_role_id, ruby_element_id: 143,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Interviews Management"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 144,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Interviews Management"
