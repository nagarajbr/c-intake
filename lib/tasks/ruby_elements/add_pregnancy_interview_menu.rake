namespace :add_pregnancy_interview_menu do
	desc "This is a template to create menu items"
	task :add_pregnancy_interview_menu => :environment do

			# level_2_menu - Pregnancy
			level_2_menu = RubyElement.find(119)

			level_3_menu = RubyElement.create(element_name:"/19/assessment_edit/session[:CLIENT_ASSESSMENT_ID]/edit_common_assessment",element_title:"Pregnancy-Interview", element_type: 6350, element_microhelp:"19/assessment_")
