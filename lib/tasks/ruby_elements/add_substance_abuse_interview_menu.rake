namespace :add_substance_abuse_interview_menu do
	desc "This is a template to create menu items"
	task :add_substance_abuse_interview_menu => :environment do

			# level_2_menu - Substance Abuse
			level_2_menu = RubyElement.find(113)

			level_3_menu = RubyElement.create(element_name:"/32/assessment_edit/session[:CLIENT_ASSESSMENT_ID]/edit_common_assessment",element_title:"Substance Abuse-Interview", element_type: 6350, element_microhelp:"32/assessment_")
