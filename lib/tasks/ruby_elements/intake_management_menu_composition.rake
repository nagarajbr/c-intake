namespace :add_intake_management_maintenance_menus do
	desc "This is a template to create menu items"
	task :add_intake_management_maintenance_menus => :environment do
		...
		# else
			...
			# level_1_menu.element_name = '/household_registration_wizard/index'
			...
			# Household composition menu
			level_1_menu_id = 840
			level_2_menu = RubyElement.create(element_name:"/household_registration/index",element_title:"Household Composition", element_type: 6350)
				RubyElementReltn.create(parent_element_id: level_1_menu_id,child_element_id: level_2_menu.id, child_order: 20)
			...
			# Household Relation menu
			level_1_menu_id = 840
			level_2_menu = RubyElement.create(element_name:"/household_relations/navigate_to_household_relations",element_title:"Household Relations", element_type: 6350)
				RubyElementReltn.create(parent_element_id: level_1_menu_id,child_element_id: level_2_menu.id, child_order: 30)

			level_3_menu = RubyElement.create(element_name:"/household_relations/navigate_to_household_relations",element_title:"Household Relations", element_type: 6350, element_microhelp:"household_relations")
				RubyElementReltn.create(parent_element_id: level_2_menu.id,child_element_id: level_3_menu.id, child_order: 10)
		...
		# Household Finance Menu
			level_1_menu_id = 840
			level_2_menu = RubyElement.create(element_name:"/household_finance/navigate_to_household_finance_index",element_title:"Household Finance", element_type: 6350)
				RubyElementReltn.create(parent_element_id: level_1_menu_id,child_element_id: level_2_menu.id, child_order: 40)
