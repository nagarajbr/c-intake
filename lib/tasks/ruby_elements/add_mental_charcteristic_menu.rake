namespace :add_mental_charcteristic_menu do
	desc "This is a template to create menu items"
	task :add_mental_charcteristic_menu => :environment do
		level_2_menu = RubyElement.find(12)
		level_3_menu = RubyElement.create(element_name:"/clients/mental/characteristics/index",element_title:"Mental Health", element_type: 6350, element_microhelp:"mental/characteristics")
			RubyElementReltn.create(parent_element_id: level_2_menu.id,child_element_id: level_3_menu.id, child_order: 33)
