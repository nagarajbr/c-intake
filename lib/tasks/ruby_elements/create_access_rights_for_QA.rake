namespace :access_rights_for_qa do
	desc "Creating access rights for qa user"
	task :create_access_rights_for_qa => :environment do
		user_role_id = 7 #QA
		connection = ActiveRecord::Base.connection()
		delete_script = "DELETE FROM access_rights where role_id = " + user_role_id.to_s
		connection.execute(delete_script)
		AccessRight.create(role_id: user_role_id, ruby_element_id: 1,    access:'Y', created_at: Time.now, updated_at: Time.now)   # "Pre-screening"
			AccessRight.create(role_id: user_role_id, ruby_element_id: 2,    access:'Y', created_at: Time.now, updated_at: Time.now)   # "Initial Survey"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 3,    access:'Y', created_at: Time.now, updated_at: Time.now)   # "Pre Screen"
		...
		AccessRight.create(role_id: user_role_id, ruby_element_id: 135,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Workload Management"
			...
			AccessRight.create(role_id: user_role_id, ruby_element_id: 143,  access:'N', created_at: Time.now, updated_at: Time.now)   # "Interviews Management"
				...
				AccessRight.create(role_id: user_role_id, ruby_element_id: 716,  access:'Y', created_at: Time.now, updated_at: Time.now)    #"alerts"
	...
	#   AccessRight.create(role_id: user_role_id, ruby_element_id: 168,  access:'Y', created_at: Time.now, updated_at: Time.now)   #
	#   AccessRight.create(role_id: user_role_id, ruby_element_id: 169,  access:'Y', created_at: Time.now, updated_at: Time.now)   #
	...
	#   AccessRight.create(role_id: user_role_id, ruby_element_id: 181,  access:'Y', created_at: Time.now, updated_at: Time.now)   #
	...
	#   AccessRight.create(role_id: user_role_id, ruby_element_id: 188,  access:'Y', created_at: Time.now, updated_at: Time.now)   #
		...
		AccessRight.create(role_id: user_role_id, ruby_element_id: 190,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Utilities Management"
			AccessRight.create(role_id: user_role_id, ruby_element_id: 191,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Application Users"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 192,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Profile"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 193,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "New"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 194,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Edit"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 195,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Reset Password"
			...
			AccessRight.create(role_id: user_role_id, ruby_element_id: 198,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "System Parameters"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 199,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "System Parameters"
			AccessRight.create(role_id: user_role_id, ruby_element_id: 200,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Lookup code values"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 201,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Lookup code values"
			AccessRight.create(role_id: user_role_id, ruby_element_id: 202,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Service Programs"
				AccessRight.create(role_id: user_role_id, ruby_element_id: 203,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "Service Programs"

		# AccessRight.create(role_id: user_role_id, ruby_element_id: 197,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "System Unlock"
		# AccessRight.create(role_id: user_role_id, ruby_element_id: 205,  access:'Y', created_at: Time.now, updated_at: Time.now)   # "System lock"
