namespace :add_my_queues_menu_to_work_load_management do
	desc "This is a template to create menu items"
	task :add_my_queues_menu_to_work_load_management => :environment do
		...
		level_2_menu = RubyElement.create(element_name:"/my_queues/summary",element_title:"My Queues", element_type: 6350, element_microhelp:"my_queues")
