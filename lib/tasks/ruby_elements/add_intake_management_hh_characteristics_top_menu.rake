namespace :add_intake_management_menu do
	...
	task :add_intake_management_hh_characteristic_top_menu => :environment do
		level_2_menu = RubyElement.find(841)
		level_3_menu = RubyElement.create(element_name:"/household_characteristics/navigate_to_household_characteristics_index",element_title:"Household Characteristics", element_type: 6350, element_microhelp:"household_characteristics")
			RubyElementReltn.create(parent_element_id: level_2_menu.id,child_element_id: level_3_menu.id, child_order: 40)
