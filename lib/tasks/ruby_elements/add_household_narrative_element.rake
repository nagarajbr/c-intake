namespace :add_household_narrative_menu do
	desc "This is a template to create menu items"
	task :add_household_narrative_menu => :environment do
		level_2_menu = RubyElement.find(841)
		level_3_menu = RubyElement.create(element_name:"/household_narative/index",element_title:"Household Narrative", element_type: 6350, element_microhelp:"household_narative")
