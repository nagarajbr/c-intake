...
has_paper_trail :class_name => 'AddressVersion' ,:on => [:update, :destroy]
    ...
    validates_length_of :primary, is:10, :allow_nil => true, message: " number should be of 10 digits."
    validates_length_of :secondary, is:10, :allow_nil => true, message: " number should be of 10 digits."
    validates_length_of :other, is:10, :allow_nil => true, message: " number should be of 10 digits."
    validates :email_address, :allow_nil => true, format: { with: /\A\S+@.+\.\S+\z/,
